...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_supplier_validation',
    download_url='https://github.com:nantic/trytond-product_supplier_validation.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_supplier_validation.git'
    },
    classifiers=[
